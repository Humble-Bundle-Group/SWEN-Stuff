...
public class RepairManager {
    ...
    public String toString(int i) {
        return this.repairList.get(i).getId() + this.repairList.get(i).getAutomobile().toString() + this.repairList.get(i).getStatus().getStanding() + this.repairList.get(i).getDescription();
    }
}
